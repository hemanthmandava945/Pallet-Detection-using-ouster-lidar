    ...
    def _update(self, scan: LidarScan) -> LidarScan:
        ...
        for i, (field, ae, buc, model) in enumerate(self.paired_list):
            ...
            if self._use_opencv:
                ...
                # is staggered.
                instance_id_img, class_id_img, instance_ids, class_i
                ds = self.create_filled_masks(results, scan)
                print("the instance_01 : ", instance_id_img)
                print("the instance_02: ", instance_ids)
                print("the instance_03 : ", class_ids)
